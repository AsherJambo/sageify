...
חשוב מאוד: פרמט את התשובה שלך בדיוק בצורה הבאה, עם שלושה סעיפים מופרדים ע"י הסימנים המדויקים הבאים:

---CARD1---
כותרת: מפת צרכים רגשית
נתח את המסעות וזהה את 3 המחסומים הרגשיים הנפוצים ביותר (למשל: פחד משעמום, חיפוש אחר מורשת, חוסר ביטחון עצמי). עבור כל מחסום תן כותרת קצרה, הסבר של 2-3 משפטים, ואחוז משוער של משתתפים שחוו אותו. זהה גם את 2 סוגי המשמעות המבוקשים ביותר שהמשתתפים מחפשים. הצג את הכל בצורה ברורה עם אימוג'ים.
---CARD2---
כותרת: תובנות לשיפור המערכת
נתח היכן משתמשים "נתקעים" במסע. זהה דפוסים של נטישה, שאלונים שלא הושלמו, או חלקים שמקבלים ציונים נמוכים. תן 3-4 תובנות מעשיות לשיפור תהליך השאלון והייעוץ, מבוססות על הדאטה. כל תובנה צריכה לכלול את הבעיה וההמלצה לפתרון.
---CARD3---
כותרת: ערך שוק הנתונים
כתוב פסקה תמציתית אחת (4-6 משפטים) שמסכמת את הערך העסקי/אסטרטגי של מגמות הנתונים הנוכחיות. התייחס לגודל המדגם, לממצאים המרכזיים, ולפוטנציאל של התובנות עבור שיפור השירות או הרחבתו. כתוב בטון "Investor Ready" - מקצועי, ממוקד ומשכנע.
---END---

חשוב: השתמש בדיוק בסימנים ---CARD1---, ---CARD2---, ---CARD3---, ---END--- כדי להפריד בין הסעיפים. אל תוסיף טקסט מחוץ לסעיפים.`;

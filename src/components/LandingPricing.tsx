...
const plans = [
  ...
  },
  {
    ...
    badge: 'AI + ייעוץ תעסוקתי לפרק הבא',
    price: '599',
    desc: 'הכל ב-Navigator, בתוספת ליווי אישי של יועצי תעסוקה לתעסוקה אקטיבית אחרי פרישה',
    features: [
      'כל מה שב-Navigator',
      '2 פגישות ייעוץ תעסוקתי ממוקד (תעסוקה אקטיבית אחרי פרישה)',
      'כיול מומחה למפת הדרכים',
      'ליווי בתהליך המעבר לעיסוק הבא',
      'גישה לקהילת פורשים',
      'תמיכה מועדפת',
    ],
    highlighted: true,

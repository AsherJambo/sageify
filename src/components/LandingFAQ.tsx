...
const faqs = [
  ...
  { q: 'האם אפשר להשתמש ב-Sageify באופן עצמאי?', a: 'כרגע הגישה למערכת מתבצעת דרך ארגונים או יועצי תעסוקה המתמחים בתעסוקה אקטיבית אחרי פרישה. צרו קשר ונשמח לחבר אתכם לגורם המתאים.' },

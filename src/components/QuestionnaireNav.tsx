    ...
    <div className={`flex ${showPrev && (showNext || showComplete) ? 'justify-between' : 'justify-center'} items-center pt-6`}>
      {showPrev && (
        <button
          ...
          className="group inline-flex items-center gap-2.5 px-7 py-3.5 rounded-2xl bg-card text-foreground font-medium font-display tracking-wide border border-border/60 disabled:opacity-20 hover:border-secondary/30 hover:bg-card/80 hover:shadow-[var(--shadow-card)] transition-all duration-300"
        >
